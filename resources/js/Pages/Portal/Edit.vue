...
const form = useForm({
    _method :'PUT',
    code: 'JOB-',
    name: props.jobs.name,
    location: props.jobs.location,
    level: props.jobs.level,
    salary: props.jobs.salary,
    description: props.jobs.description,
    no_of_vacancy: props.jobs.no_of_vacancy,
    status: props.jobs.status,
    public: props.jobs.public,
    style: props.jobs.style,
    organization_id:props.jobs.organization_id,
    date_start_job: props.jobs.date_start_job,
});
...
const submitForm = () => {
    ...
    //return;
    form.post(route('jobs.update', props.jobs.id), {
        //preserveScroll: true,
        onSuccess: () => {},
...
onMounted(()=>{
    setTimeout(()=>{moneditor.value.setHTML(props.jobs.description)}, 400);
});
</script>
                    ...
                    <div class="md:grid md:grid-cols-3 md:gap-6">
                        <div class="md:col-span-1">
                            <div class="px-4 sm:px-0">
                                <h3 class="text-lg font-medium leading-6 text-gray-900">Jobs Informations</h3>
                                ...
                                <div class="overflow-hidden shadow sm:rounded-md">
                                    <div class="bg-white px-4 py-5 sm:p-6">
                                        <div class="grid grid-cols-6 gap-6">
                                            ...
                                            <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                                <JetLabel for="orange-toggle" value="Should be posted?" />

                                                <label for="orange-toggle" class="inline-flex relative items-center mr-5 mt-2 cursor-pointer">
                                                    <input type="checkbox" v-model="form.public" id="orange-toggle" class="sr-only peer" >
                                                    ...
                                                    <span class="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">Publish on Portal</span>
                                                </label>
